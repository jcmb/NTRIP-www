            ...
            while reconnectTry<=maxReconnect:
                ...
                if error_indicator==0:
                    ...
                    while not found_header:
                        casterResponse=self.socket.recv(4096) #Note that the is does not handle really large source tables.
...
if __name__ == '__main__':
    ...
    parser.add_option("-t", "--latitude", type="float", dest="lat", default=39.56, help="Your latitude.  Default: %default")
    parser.add_option("--GGA", "--GGA", action="store_true", dest="GGA", default=False)
    parser.add_option("-g", "--longitude", type="float", dest="lon", default=-105.5, help="Your longitude.  Default: %default")
